...
public class Getting_GpsBusData_bckup_20161114 extends WakefulBroadcastReceiver{
	...
	public void setAlarm(Context context) {
		...
		Intent intent = new Intent(context, Getting_GpsBusData_bckup_20161114.class);
			...
			if (bus_score.getCount()>0) {
				...
				Double get_score =  bus_score.getDouble(KEY_SCORE) +
									score.calculo(Double.parseDouble(dataBusArray[index_LATITUDE]), 
												 bus_score.getDouble(KEY_B_LATITUDE), 
												 Double.parseDouble(dataBusArray[index_LONGITUDE]), 
												 bus_score.getDouble(KEY_B_LONGITUDE));
