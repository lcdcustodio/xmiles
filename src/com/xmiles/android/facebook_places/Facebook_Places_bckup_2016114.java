...
//--------------------------------------------------------
 public class Facebook_Places_bckup_2016114 extends AsyncTask<Void,Void,JSONArray> {
      ...
      public Facebook_Places_bckup_2016114(String string, float Lat, float Long, int dist) {	  
	   this.context = string;
	   this.latitude = Lat;
	   this.longitude = Long;
	   this.distance = dist;
