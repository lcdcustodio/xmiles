...
public class FbPlaces_Download extends WakefulBroadcastReceiver {	
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
            	...
            	try {
            		...
            		findPlaces = new Facebook_Places(c,Utility.mFacebook.getAccessToken(),Lat,Long,MIN_DISTANCE).execute().get();
            	      		...
            	      		for (int i = 0; i < n_places; i++) {
        		            	...
        		            	try {
	        		    			...
	        		    			jsonArray_category = findPlaces.getJSONObject(i).getJSONArray("category_list");
	        		  	    	    ...
	        		  	    	    String get_distance = String.format("%.2f",dist_calc.calculo(jsonObject_location.getDouble("latitude"), lat_double, jsonObject_location.getDouble("longitude"), long_double));
