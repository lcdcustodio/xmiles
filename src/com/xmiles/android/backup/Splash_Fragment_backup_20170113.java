...
public class Splash_Fragment_backup_20170113 extends Fragment {
	...
	public Splash_Fragment_backup_20170113() {
	}
	...
	private class PrefetchData extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... arg0) {
			...
			//------
			Log.e(TAG,"Utility.mFacebook.getAccessToken(): " + Utility.mFacebook.getAccessToken());
			// facebook profile
